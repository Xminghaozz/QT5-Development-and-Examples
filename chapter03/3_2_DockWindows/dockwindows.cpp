...
DockWindows::DockWindows(QWidget *parent)
    : QMainWindow(parent)
{
    this->setWindowTitle(tr("DockWindows"));        // 设置主窗口的标题栏文字
    QTextEdit *te = new QTextEdit(this);            // 定义一个QTextEdit对象为主窗口
    te->setText(tr("Main Window"));
    te->setAlignment(Qt::AlignCenter);
    this->setCentralWidget(te);                     // 将此编辑框设为主窗口的中央窗体
    // 停靠窗口1
    ...
    dock->setFeatures(QDockWidget::DockWidgetClosable |
                      ...
                      QDockWidget::DockWidgetVerticalTitleBar);    //全部特性
