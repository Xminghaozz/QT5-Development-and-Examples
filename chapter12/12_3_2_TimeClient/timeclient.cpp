    ...
    : QDialog( parent )
{
    ...
    connect( serverNameLineEdit, &QLineEdit::textChanged, this, &TimeClient::enableGetBtn );
    connect( portLineEdit, &QLineEdit::textChanged, this, &TimeClient::enableGetBtn );
    ...
    connect( tcpSocket, &QAbstractSocket::errorOccurred, this, &TimeClient::showError );
